...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>chienhub chào ae<Color=/>"):Display()
    wait(.5)
...
local Window = OrionLib:MakeWindow({Name = "chienhub", HidePremium = false, IntroText = "chienhub⚜️", SaveConfig = true, ConfigFolder = "NightHub"})
...
W:AddLabel("chienhub SCRIPT")
W:AddLabel("Discordchienhub")
local Section = W:AddSection({
    Name = "Status"
})
